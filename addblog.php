     	...
     	<tr>
     		...
     		<form method="post" action="destination.php" enctype="multipart/form-data">
				<fieldset>
				  ...
				  <input type="hidden" value="sumbitpost" id="job" name="job">
				  <input class="btmspace-15" type="text" value="" id="titlepost" name="titlepost" placeholder="Enter Title" required="required">
				  <input class="btmspace-15" type="text" value="<?php echo $_SESSION['username']; ?>" id="writerpost" name="writerpost" placeholder="Enter Writer" required="required">

				  <textarea type="text" value="" id="bodypost" name="bodypost" required="required"></textarea>
				  <br><input type="file" name="file" name="file">
