...
<head>
    ...
    <!--[if IE]>
        ...
        <![endif]-->
    <title><?php echo "PHP Dynamic Site :: Negar" ?></title>
    ...
    <div id="nav-wrapper" >
        ...
        <div class="container">
            <div class="navbar-header ">
                ...
                <a class="navbar-brand" href="#"><img src="assets/img/vijaya.png" alt="" /></a>
            </div>
           ...
           <div class="overlay"  >
               <div class="container" >
                <div class="row text-center">
                    <div class="col-md-12">
                      <h1 ><?= "PHP" ?> <i class="fa fa-ioxhost fa-2x" ></i> <?= "Negar" ?> </h1> 
                         <h4  >
										<?= "This is my PHP site that build in" ?>
           ...
           <div class="col-md-4 col-sm-4" >
              ...
              <br />
               ...
               <div class="col-md-4 col-sm-4 subscribe"  >
                   ...
                   <hr />
                    <br />
                   <form action="sendemail.php" method="Post"> <!-- NEGAR WAS HERE :) -->
					   <div class="form-group">
						   <input type="text" placeholder="Enter Your Email Here" class="form-control" name="emailAddress" />
						   <br />
						   
						    <input type="submit" value="CLICK TO SUBSCRIBE" class="btn btn-primary btn-lg btn-block black-btn">
