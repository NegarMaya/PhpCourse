...
if ($job=="edituser")
{
	...
	while ($row=mysqli_fetch_array($result, MYSQLI_ASSOC)){
		...
		echo "<input type='hidden' id='job' name='job' value='edituser'>";
		echo "Name: <input type='text' id='name' name='name' value='$name' class='btmspace-15'>";
		echo "Full Name:<input type='text' id='fullname' name='fullname' value='$fullname' class='btmspace-15'>";
		echo "Email:<input type='text' id='email' name='email' class='btmspace-15' value='$email'>";
		echo "<button type='submit' value='submit' class='btn' id='submit'>Submit</button>";
	}
	echo "</form>";
	}
?>
